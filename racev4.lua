local library = {
	...
	colors = {
		main = Color3.fromHex('FFD300'),--  FF0000
		background = Color3.fromRGB(0, 0, 0),
		outerBorder = Color3.fromRGB(0, 0, 0),
		innerBorder = Color3.fromHex('3E3E3E'), --  280035
		topGradient = Color3.fromRGB(0, 0, 0),
		bottomGradient = Color3.fromHex('000000'),
		sectionBackground = Color3.fromHex('000000'),
		section = Color3.fromHex('FFD300'), -- 
		otherElementText = Color3.fromHex('604B06'), 
		elementText = Color3.fromHex('96ADAD'),
		elementBorder = Color3.fromHex('202020'), -- 3C0062 1E0030
		selectedOption = Color3.fromHex('858585'), -- 1E0030 3E0000
		unselectedOption = Color3.fromHex('282828'),
		hoveredOptionTop = Color3.fromHex('414141'),
		unhoveredOptionTop = Color3.fromHex('323232'),
		hoveredOptionBottom = Color3.fromHex('323232'),
		unhoveredOptionBottom = Color3.fromHex('323232'),
		tabText = Color3.fromHex('989898') -- 001919
	},
	gui_parent = (function()
